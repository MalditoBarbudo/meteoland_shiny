...
![Ecologists working hard (modified from https://xkcd.com/303/)](resources/compiling.png)
...
![Introducing parameters in the current grid mode](resources/current_grid_mode_01.png)

### Data output

After the `Go` button is pressed app change to the `DATA OUTPUT` tab. 
